...
%TODO: (SRB) this paragraph repeats the last one.
...
% TODO: (SRB) what is p_i^{mod}? It seems that it's defined later on. Editing problem.
...
% TODO: (SRB) draw a definitive conclusion.
