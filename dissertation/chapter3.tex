...
% TODO: (SRB) What does the x in $\theta_{sjk} = x$ mean? Is it a question difficulty?
% TODO: (SRB) consistency... \theta_s, \theta_{sjk}, \Theta_s
% TODO: (SRB) quotes are wonky
...
% TODO: (SRB) coarse-grained, not course-grained... unless this is a pun?
...
% TODO: (SRB) my experience with Levenshtein distance is that it rarely performs as well as counting the number of letters in common.
